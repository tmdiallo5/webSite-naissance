...
public class AuthentificationService {
    ...
    public AuthentificationService(ProfilesRepository profilesRepository, ValidationService validationService, BCryptPasswordEncoder passwordEncoder, ActivationsService activationsService, ProfileMapper profileMapper, RolesRepository rolesRepository) {
